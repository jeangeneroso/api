...
public class BuscarTitulosOutrosEmissoresServiceImpl {
    ...
    private static final Logger LOG = Logger.getLogger(BuscarTitulosOutrosEmissoresServiceImpl.class.getName());

    public ResponseEntity<Object> buscarTitulosOutrosEmissores(String emissor) {
        LOG.info("Iniciando o serviço para emissores fora do Banco Master");
